    ...
    extend: {
      ...
      keyframes: {
        ...
        pulseGlow: {
          ...
          '50%': { 
            textShadow: '0 0 10px rgba(124, 58, 237, 0.6), 0 0 20px rgba(124, 58, 237, 0.4), 0 0 30px rgba(124, 58, 237, 0.3)' 
          },
        },
      },
      backgroundImage: {
        ...
        'vydhya-gradient': 'linear-gradient(135deg, #0A1120 0%, #0F172A 50%, #1E3A8A 100%)',
      },
    },
  },
  plugins: [],
